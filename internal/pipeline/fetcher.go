...
func (rp *RepoProcessor) ProcessRepository(ctx context.Context, repoPath string, branch string) (*models.ProcessingResult, error) {
	...
	tree, err := rp.provider.GetRepositoryTree(ctx, repoPath, branch)
